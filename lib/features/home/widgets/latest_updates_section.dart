...
class _LatestUpdatesSectionState
    extends ConsumerState<LatestUpdatesSection> {
  int activeIndex = 0;
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed:
                        controller.loadLatestContents,
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          const Color(0xff8A0038),
...
class UpdateCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final title = data.title.valueForLanguage(
      isTamil: isTamil,
    );

    final shortDescription =
        data.shortDescription.valueForLanguage(
      isTamil: isTamil,
    );
